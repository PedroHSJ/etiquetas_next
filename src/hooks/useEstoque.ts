...
export function useEstoque() {
  ...
  const buscarProdutos = useCallback(async (termo = "", limit = 50): Promise<ProdutoSelect[]> => {
  ...
  const entradaRapida = useCallback(async (request: EntradaRapidaRequest): Promise<boolean> => {
    try {
