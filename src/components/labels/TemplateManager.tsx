...
import { LabelType, LabelTemplate, LABEL_TYPES_CONFIG } from '@/lib/types/labels';
...
export const TemplateManager: React.FC<TemplateManagerProps> = ({
  ...
  const createNewTemplate = (labelType: LabelType) => {
    ...
    const newTemplate: LabelTemplate = {
      ...
      gap_horizontal: 10,
      gap_vertical: 10,
      fields: config.defaultFields?.map((field, index) => ({
        id: `default_${index}`,
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Gerenciar Templates de Etiquetas</h1>
