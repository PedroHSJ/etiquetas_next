          ...
          <UICardHeader className="pb-3 border-b">
            <UICardTitle className="text-base font-semibold flex items-center justify-between">
              ...
              {loadingPrinters ? (
                ...
                <Badge
                  className="bg-emerald-50 text-emerald-600 border-emerald-200 gap-1 px-2.5 py-0.5"
                  variant="outline"
                >
                ...
                <Badge
                  variant="outline"
                  className="bg-rose-50 text-rose-600 border-rose-200 gap-1 px-2.5 py-0.5"
                >
            ...
            <UICardDescription>
              Status da ponte de comunicação local.
            </UICardDescription>
          </UICardHeader>
                ...
                {!isOnline ? (
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="mt-2 text-sm text-amber-700">
                          <p>
                            Parece que não há nenhum serviço de impressão
                            (LabelPrintService) online para o seu restaurante.
                            Certifique-se de que instalou o aplicativo no seu
                  ...
                  <div className="space-y-3">
                    <Label className="text-slate-500 font-medium">
                      Impressoras Físicas Detectadas localmente:
                    </Label>
        ...
        <UICard className="border-none shadow-sm flex flex-col h-full">
          <UICardHeader className="pb-3 border-b">
            <UICardTitle className="text-base font-semibold">
              Credencial de Instalação
            </UICardTitle>
            <UICardDescription>
              Gere o Token de Integração Inquebrável (JWT) para instalar o
              Serviço.
            </UICardDescription>
          </UICardHeader>
          <UICardContent className="pt-6 flex-1 flex flex-col gap-6">
            <div className="space-y-4">
              <p className="text-sm text-slate-600 leading-relaxed">
                Para habilitar impressões por nuvem, você deve ter o Serviço
                Físico de Etiquetas instalado na máquina conectada via USB na
                impressora, e inserir um Token para assinar a conexão no momento
                da instalação.
              </p>
            ...
            {token && (
              <div className="mt-auto bg-slate-50 border border-slate-200 rounded-lg p-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                <Label
                  htmlFor="token"
                  className="text-xs uppercase tracking-wider text-slate-500 font-semibold mb-2 block"
                >
                ...
                <p className="text-[11px] text-slate-400 mt-2 flex items-center gap-1">
                  ...
                  Aviso: Copie o token agora e cole-o na etapa solicitada do
