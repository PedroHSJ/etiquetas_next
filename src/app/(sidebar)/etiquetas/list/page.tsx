...
export default function Page() {
  ...
  const [filteredEtiquetas, setFilteredEtiquetas] = useState<Label[]>([]);
                          ...
                          <div className="flex items-center gap-3">
                            <Avatar>
                              <AvatarFallback className="bg-emerald-100 text-emerald-600">
                                {getInitials(etq.product?.name ?? "?")}
                              </AvatarFallback>
                            </Avatar>
                            <div>
                              <h3 className="font-medium">
                                {etq.product?.name ?? "Produto desconhecido"}
                              </h3>
                              ...
                              <p className="text-xs text-muted-foreground">
                                Impressa em:{" "}
                                {format(new Date(etq.printDate), "dd/MM/yyyy", {
                                  locale: ptBR,
                                })}
                              </p>
                            </div>
                      ...
                      <TableBody>
                        {paginatedEtiquetas.map((etq) => (
                          <TableRow key={etq.id}>
                            ...
                            <TableCell>{etq.quantity}</TableCell>
                            <TableCell>
                              {format(new Date(etq.printDate), "dd/MM/yyyy", {
                                locale: ptBR,
                              })}
