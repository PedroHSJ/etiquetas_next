          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {Object.entries(LABEL_TYPES_CONFIG).map(([labelType, config]) => {
                const typeTemplates = getTemplatesByType(
              ...
              <CardContent className="space-y-4">
                  ...
                  <div key={field.id}>
                    ...
                    {field.type === "date" ? (
                      <Input
                        ...
                        onChange={(e) =>
                          handleDataChange(field.label, e.target.value)
                        }
                      />
                      ...
                      <div className="flex items-center gap-2">
                        <Input
                          ...
                          type="number"
                          value={
                            labelData[field.label]?.replace("°C", "") || ""
                          }
                          onChange={(e) =>
                            handleDataChange(field.label, e.target.value)
                          }
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={labelCount}
                    onChange={(e) =>
                      setLabelCount(parseInt(e.target.value) || 1)
                    }
                  />
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-sm text-gray-500">
                  Escolha um template na lista ao lado para visualizar e
