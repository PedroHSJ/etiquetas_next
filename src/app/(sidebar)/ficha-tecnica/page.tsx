...
} from "@/lib/services/technicalSheetService";
    ...
    try {
      ...
      const saveData: SaveTechnicalSheetData = {
        ...
        ingredientes: sheet.ingredients.map((ingredient, index) => ({
          ...
          quantidade_original:
            (ingredient as EditableIngredient).originalQuantity || ingredient.quantity,
          product_id: (ingredient as EditableIngredient).productId
            ? parseInt((ingredient as EditableIngredient).productId!)
            : undefined,
          ordem: index,
        })),
      };
    ...
    <div className="container mx-auto space-y-6 p-6">
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Automatizada com IA</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Flexibilidade total</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Quantidades proporcionais</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Ajustes personalizados</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>Siga estes passos para gerar sua ficha técnica</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <TechnicalSheetGenerator organizationId={selectedOrganization.id} onSave={handleSave} />
    </div>
  );
}
